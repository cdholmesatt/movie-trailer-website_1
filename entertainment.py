...
------------------------------------------------------------------------------
This is the 1st program for the Nanodegree for Full Stack Developer - P1
Available Modules:
media.py
entertainment.py
...
movies = [matrix, scarface, thegoodbadugly, independenceday, sanandreas,
          jurassicworld, goodfellas, trainingday, age_of_ultron, django,
          godfather, pulpfiction, killbill, killbill2]
